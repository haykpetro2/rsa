...
@section('page_header',trans('policy.Import Policies other'))

@section('content')
    <div class="fix-height">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                {!! Form::open(['url' => action('PolicyImportController@postImportXls'), 'files' => true, 'class' => 'simple_form form-horizontal']) !!}
