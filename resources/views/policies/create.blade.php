...
@section('title',trans('policy.Create Policy'))
@section('page_header',trans('policy.Create Policy'))
...
@section('content')
	<div class="fix-height">
		...
		<div class="row">
			...
			{!! Form::model($policy, ['url' => action('PoliciesController@store'), 'class' => 'simple_form']) !!}
