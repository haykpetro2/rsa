...
return [
    ...
    */
    ...
    'custom' => [
        'client' => [
            'last_name' =>['required' => 'Фамилия страхователя обязательна для заполнения.'],
            'first_name' =>['required' => 'Имя страхователя обязательна для заполнения.'],
            'middle_name' =>['required' => 'Отчество страхователя обязательна для заполнения.'],
            'date_birth' =>['required' => 'Дата рождения страхователя обязательна для заполнения.'],
            'passport_serial' =>['required' => 'Серия паспорта страхователя обязательна для заполнения.'],
            'passport_number' =>['required' => 'Номер паспорта страхователя обязательна для заполнения.'],
        ],
    ],
